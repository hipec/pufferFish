This is the software implementation of PufferFish programming model for NUMA-aware task parallelism. Instructions on using this software is provided in the file ``guide.pdf''.
